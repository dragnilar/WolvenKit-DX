...
namespace WolvenKit
{
    internal class WKPackage
    {
            ...
            List<XElement> Contents)
        {
            ...
            if (Author.Item2 != null || Author.Item2 != string.Empty)
                authorelement.Add(new XElement("actionLink", Author.Item2));
            if (Author.Item3 != null || Author.Item3 != string.Empty)
                authorelement.Add(new XElement("web", Author.Item3));
            if (Author.Item4 != null || Author.Item4 != string.Empty)
                authorelement.Add(new XElement("facebook", Author.Item4));
            if (Author.Item5 != null || Author.Item5 != string.Empty)
                authorelement.Add(new XElement("twitter", Author.Item5));
            if (Author.Item6 != null || Author.Item6 != string.Empty)
