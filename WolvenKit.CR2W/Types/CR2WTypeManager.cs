...
namespace WolvenKit.CR2W.Types
{
    ...
    public class CR2WTypeManager
    {
        ...
        public CR2WTypeManager()
        {
            ...
            // TODO - These do not work and cause errors
#if DEBUG
            // *.w2p
            ...
            foreach (var t in vectors) Register(t, new CVector(null));
            ...
            foreach (var t in cnames) Register(t, new CName(null));

            foreach (var enm in typeof(Enums).GetNestedTypes()) Register(enm.Name, new CName(null));
        }
